...
void test_dpa(){
    ...
    int n = 10000000;
    int n2 = 30;
    cout << "Working with multi-dim of n=" << n << ", n2=" << n2 << endl;

    DensePauliArray p1 = DensePauliArray::random(n2, n);
    DensePauliArray p2 = DensePauliArray::random(n2, n);
