...
def main():
    ...
    label_list = [c3h8_labels_positions]
    # molecule_names = [
    ...
    print(
        f"Ratio X ops: {100*n_x/total:.2f}%, Ratio Z ops: {100*n_z/total:.2f}%, Ratio Y ops: {100*n_y/total:.2f}%, Ratio I ops: {100*n_i/total:.2f}%"
    )
...
if __name__ == "__main__":
    ...
    print(os.getcwd())
    ps.dump_stats(f"./results/{datetime.datetime.now().strftime('%Y-%m-%d---%Hh%Mm')}.prof")
